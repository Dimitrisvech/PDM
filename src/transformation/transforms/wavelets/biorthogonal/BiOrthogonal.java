 ...
 * BiOrthogonal.java
 */
package transformation.transforms.wavelets.biorthogonal;
...
public class BiOrthogonal extends Wavelet {
   ...
   * @see transformation.transforms.wavelets.Wavelet#forward(double[], int)
   */
   ...
   * @author Christian Scheiblich (cscheiblich@gmail.com)
   * @date 28.03.2015 18:44:24 (non-Javadoc)
   * @see transformation.transforms.wavelets.Wavelet#reverse(double[], int)
   */
